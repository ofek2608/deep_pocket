...
@Immutable
public final class ElementConversionsOld {
	private static final Logger LOGGER = LogUtils.getLogger();
	public static final ElementConversionsOld EMPTY = new ElementConversionsOld(new TConvertible[0], Collections.emptyMap());
	private final TConvertible[] baseElements;
	private final Map<ElementType,long[]> values;

	private ElementConversionsOld(TConvertible[] baseElements, Map<ElementType,long[]> values) {
		this.baseElements = baseElements;
		this.values = values;
	}


	public static void encode(FriendlyByteBuf buf, ElementConversionsOld conversions) {
	...
	public static ElementConversionsOld decode(FriendlyByteBuf buf) {
		...
		return new ElementConversionsOld(baseElements, values);
	}
	...
	public static final class Builder {
		...
		public ElementConversionsOld build() {
			...
			return new ElementConversionsOld(baseElements, resultValues);
		}
	}
